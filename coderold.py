...
class Coder(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.sfb = SideButtonframe(self.f1,self.txt)
        self.f2 = ttk.Frame(self.notebook, width=1900, height=1080)
        self.f2.grid(row=0, column=1)
        self.notebook.add(self.f2, text="TAB2")

        self.btn1 = tk.Button(self.f2, text="imports", bg="orange", bd=4,command=self.qukimp)
        self.btn1.grid(row=5, column=1)
        self.btn2 = tk.Button(self.f2, text="Entry", bg="orange",bd =4, command=self.e_code)
        self.btn2.grid(row=6, column=1)
        self.btn3 = tk.Button(self.f2, text="Button Code1", bg="orange",bd=6, command=self.button_code)
        self.btn3.grid(row=7, column=1)
        self.btn4 = tk.Button(self.f2, text="Button code2", bg="orange", bd=6,command=self.button_code2)
        self.btn4.grid(row=8, column=1)
        self.btn5 = tk.Button(self.f2, text="Menu OOP", bg="violet",bd =8)
        self.btn5.grid(row=9, column=1)
        self.btn6 = tk.Button(self.f2, text="Label1", bg="orange",bd=4, command=self.label_code1)
        self.btn6.grid(row=10, column=1)
        self.btn7 = tk.Button(self.f2, text="Label2", bg="orange",bd=6, command=self.label_code2)
        self.btn7.grid(row=11, column=1)
        self.btn8 = tk.Button(self.f2, text="Notebook empty tabs", bg="orange", bd=6)
        self.btn8.grid(row=12, column=1)
        self.btn9 = tk.Button(self.f2, text="Canvas1", bg="light blue",bd=8, command=self.canvascol)
        self.btn9.grid(row=13, column=1)
        self.btn10 = tk.Button(self.f2, text="Canva2", bg="orange",bd=8, command=self.canvasrow)
        self.btn10.grid(row=14, column=1)
        self.btn11 = tk.Button(self.f2, text="combobox", bg="orange", bd=8, command=self.combo_code)
        self.btn11.grid(row=15, column=1)
        self.btn12 = tk.Button(self.f2, text="combobox2", bg="orange",bd=8, command=self.combo_code2)
        self.btn12.grid(row=16, column=1)
        self.btn13 = tk.Button(self.f2, text="spin box", bg="orange", bd=6,command=self.spin_code)
        self.btn13.grid(row=17, column=1)
        self.btn14 = tk.Button(self.f2, text="spinbox2", bg="orange",bd=6, command=self.spin_code2)
        self.btn14.grid(row=8, column=2)
        self.btn15 = tk.Button(self.f2, text="Text box", bg="light blue",bd=6, command=self.text_code)
        self.btn15.grid(row=7, column=2)
        self.btn16 = tk.Button(self.f2, text="Slider", bg="orange", bd=6,command=self.slider)
        self.btn16.grid(row=6, column=2)
        self.btn17 = tk.Button(self.f2, text="Clear", bg="orange",bd=6, command=self.clear)
        self.btn17.grid(row=5, column=2)
        self.btn18 = tk.Button(self.f2, text="Save", bg="orange",bd=6, command=self.save_code)
        self.btn18.grid(row=22, column=1)
        self.btn19 = tk.Button(self.f2, text="Open", bg="orange", bd=6, command=self.open_code)
        self.btn19.grid(row=23, column=1)
        self.btn20 = tk.Button(self.f2, text="self.", bg="orange", bd=6,command=self.insert_self)
        self.btn20.grid(row=9, column=2)
        self.btn21 = tk.Button(self.f2, text="starter code", bg="orange",bd = 6, command=self.start_code)
        self.btn21.grid(row=10, column=2)
        self.btn23 = tk.Button(self.f2, text="scrolltext", bg="orange",bd=6, command=self.scrolledtxt)
        self.btn23.grid(row=3, column=2)
        self.btn24 = tk.Button(self.f2, text="10 chkbuttons", bg="orange", bd=6)
        self.btn24.grid(row=4, column=2)
        self.btn25 = tk.Button(self.f2, text="send code copy", bg="violet",bd =12, command=self.sendcode)
        self.btn25.grid(row=5, column=2)
##        self.btn26 = tk.Button(self.f2, text="----", bg="orange",bd=8, command=self.label_code1)
##        self.btn26.grid(row=6, column=2)
##        self.btn27 = tk.Button(self.f2, text="-----", bg="orange",bd=6, command=self.label_code2)
##        self.btn27.grid(row=7, column=2)
##        self.btn28 = tk.Button(self.f2, text="--------", bg="orange", bd=6,command=notebook)
##        self.btn28.grid(row=8, column=2)
##        self.btn29 = tk.Button(self.f2, text="----", bg="light blue",bd=8, command=self.canvascol)
##        self.btn29.grid(row=9, column=2)
##        self.btn30 = tk.Button(self.f2, text="-------", bg="orange",bd=8, command=self.canvasrow)
##        self.btn30.grid(row=10, column=2)
##        self.btn31 = tk.Button(self.f2, text="------", bg="orange", bd=8, command=self.combo_code)
##        self.btn31.grid(row=11, column=2)
##        self.btn32 = tk.Button(self.f2, text="-------", bg="orange",bd=8, command=self.combo_code2)
##        self.btn32.grid(row=10, column=)
##        self.btn33 = tk.Button(self.f2, text="--------", bg="orange", bd=6,command=self.spin_code)
##        self.btn33.grid(row=11, column=3)
##        self.btn34 = tk.Button(self.f2, text="-------", bg="orange",bd=6, command=self.spin_code2)
...
##        self.but39.grid(row=17, column=3)
        ...
        self.txt4 = ScrolledText(self.f4, height=50, width=100, bg='white',bd=15)
        self.txt4.grid(row=2, column=2,sticky="nsew")
        self.sfb = SideButtonframe(self.f4,self.txt4)
...
self.label1.grid(row=5, column=2)"""
    ...
    def slider(self):
        ...
        """ + "\n")
        slider_str2 = sld_str.replace("self.slider1", "self.slider" + str(self.slidercount))
