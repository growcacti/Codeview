...
def find(event=None):
    ...
    search_top_level=Toplevel(r)

    search_top_level.title("Find Text")

    search_top_level.transient(r)
    ...
    def close_search_r():
        ...
        search_top_level.protocol('WM_DELETE_WINDOW',close_search_r)
...
content_text = Text(r, wrap='word',undo=1)
