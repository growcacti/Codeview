...
class Codeview(tk.Frame):
    def __init__(self, parent):
        ...
        self.notebook.add(self.f3, text="TAB3")
        ...
        self.txxx = ScrolledText(self.f5,
                      ...
                      font='TkFixedFont',)
        self.txx.grid(row = 0, column=5)
        self.sb2 =SideButtonframe(self.f5, self.txxx)        
        ...
        self.cvw = Cview_Buttons(self.f1,self.tx,self.lb, self.tx)
