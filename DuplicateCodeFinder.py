...
class DuplicateCodeFinder:
    def __init__(self, root):
        ...
        self.file_entry = tk.Entry(root, bd=10,bg="seashell",width=60)
        self.file_entry.grid(row=0, column=1, padx=10, pady=10, sticky="w")

        self.browse_button = tk.Button(root,bd=6,bg="light pink", text="Browse", command=self.browse_file)
        self.browse_button.grid(row=0, column=2, padx=10, pady=10, sticky="w")

        # Find Duplicates Button
        self.find_button = tk.Button(root, bd=6,bg="light blue",text="Find Duplicates", command=self.find_duplicates)
        ...
        self.results_box = scrolledtext.ScrolledText(root, bd=6,bg="seashell",wrap=tk.WORD, width=90, height=25)
